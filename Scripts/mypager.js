(function ($) {
    $.fn.pager = function (options) {
        ...
        return this.each(function () {
            var mypagecount = isNaN(options.pagecount) ? 0 : parseInt(options.pagecount);
            $(this).empty().append(renderpager(parseInt(options.pagenumber), mypagecount, options.buttonClickCallback));
